...
export default function AboutProject() {
  return (
    <section
      id="about-project"
      className="p-2 md:px-40 bg-gray-50 dark:bg-gray-800 pt-28 md:pb-10"
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            WrapTalk is a revolutionary tool that simplifies multilingual
            support in React applications
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              WrapTalk is an innovative solution that automates the translation
              process for React applications. Our tool eliminates the need for
              manual translations, API calls at runtime, and complex
            ...
            <p className="text-gray-600 dark:text-gray-300">
              ...
              components, run our CLI command, and let our AI-powered system
              handle the rest. WrapTalk generates all translations during build
              time, ensuring optimal performance and seamless user experience.
            </p>
          </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg p-8">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Support for numerous languages with high-quality
                    translations
                  </p>
                </div>
                <div className="flex flex-col items-center text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  to scan your codebase and generate translations
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-12 h-12 flex items-center justify-center bg-blue-600 text-white rounded-full mb-4 font-bold text-xl">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Your app now supports multiple languages with zero runtime
                  overhead
                </p>
              </div>
            </div>
